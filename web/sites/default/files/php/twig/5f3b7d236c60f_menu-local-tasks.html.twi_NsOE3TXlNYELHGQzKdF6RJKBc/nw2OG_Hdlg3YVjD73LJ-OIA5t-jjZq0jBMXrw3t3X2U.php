...
";
    ...
    {
        return new Twig_Source("", "themes/contrib/bootstrap/templates/menu/menu-local-tasks.html.twig", "/opt/drupal8/soprema/web/themes/contrib/bootstrap/templates/menu/menu-local-tasks.html.twig");
    }
}
