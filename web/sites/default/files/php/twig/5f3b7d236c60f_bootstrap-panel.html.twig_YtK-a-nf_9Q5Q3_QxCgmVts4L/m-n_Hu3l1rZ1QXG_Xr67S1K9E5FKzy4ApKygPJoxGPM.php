...
($context["description"] ?? null) && ($this->getAttribute(($context["description"] ?? null), "position", array()) == "invisible"))) ? ("sr-only") : ("")));
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/contrib/bootstrap/templates/bootstrap/bootstrap-panel.html.twig", "/opt/drupal8/soprema/web/themes/contrib/bootstrap/templates/bootstrap/bootstrap-panel.html.twig");
    }
}
